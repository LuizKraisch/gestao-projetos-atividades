...
<?php 
	...
	if ($dados = mysqli_query($conexao, "INSERT INTO atividades (IDProjeto, nomeAtividade, dataInicio, dataFim, infoFinalizada) VALUES ('$IDProjeto', '$nomeAtividade', '$dataInicio', '$dataFim', '$infoFinalizada')")){
